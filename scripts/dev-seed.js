// Dev seed script — creates a demo user and a sample workflow.
...
async function main() {
  ...
  if (existing) {
    ...
    const wf = new Workflow({
      ...
      owner: user._id,
      nodes: [
        { id: uuidv4(), type: 'text', config: { content: 'Hello from seed' } },
        { id: uuidv4(), type: 'delay', config: { ms: 500 } },
        { id: uuidv4(), type: 'http', config: { url: 'https://httpbin.org/get' } }
      ]
    })
    await wf.save()
